...
public partial struct Item {
    ...
    public Item(ItemTemplate template, int amount=1) {
        ...
        petSummoned = null;
        petHealth = template.petPrefab != null ? template.petPrefab.healthMax : 0;
        petLevel = template.petPrefab != null ? 1 : 0;
        petExperience = 0;
    }
    ...
    public Pet petPrefab {
        get { return template.petPrefab; }
    }
    public int usagePetHealth {
        get { return template.usagePetHealth; }
    }
